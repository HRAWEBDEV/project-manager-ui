          ...
          <form className="p-6 md:p-8 overflow-auto">
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl font-bold">{signInDic.welcome}</h1>
              ...
              <FieldDescription className="text-center">
                {signInDic.doNotHaveAccount}{" "}
                <Link href={`/${locale}/auth/sign-up`}>{signInDic.signUp}</Link>
              </FieldDescription>
            </FieldGroup>
          </form>
